...
if __name__ == "__main__":
    main() Calculate trend line using linear regression
                ...
                for i, cluster_info in enumerate(cluster_data):
                    ...
                    if len(x_values) > 1:
                        ...
                        trend_line = np.polyval([trend_slope, np.mean(normalized_pattern) - trend_slope * np.mean(x_values)], x_values)
                    else:
                    ...
                    for _, station_row in all_time_agg.iterrows():
                        ...
                        if len(station_data) > 1:
                            ...
                            metrics = {
                                ...
                                'trend_slope': abs(np.polyfit(range(len(daily_balances)), daily_balances, 1)[0]) if len(daily_balances) > 1 else 0,
